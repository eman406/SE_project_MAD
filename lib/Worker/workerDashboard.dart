...
class _WorkerDashboardState extends State<WorkerDashboard> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(_selectedIndex == 0 ? "WELCOME TO SMART ENIGINEERING" : _selectedIndex == 1 ? "Assigned Tasks" : "Account Settings"),
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            _infoRow(Icons.person_outline, "Assigned By: ${task.assignedBy}"),
